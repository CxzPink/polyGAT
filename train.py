...
from utils import load_data, accuracy, my_load_data, my_load_data_
from models import GAT, SpGAT, my_SpGAT
...
# Load data
# adj, features, labels, idx_train, idx_val, idx_test = my_load_data("cora")
adj, features, labels, idx_train, idx_val, idx_test = load_data()

# Model and optimizer
if args.sparse:
    model = my_SpGAT(nfeat=features.shape[1], 
                nhid=args.hidden, 
